...
Note that the author of this gem has created another authorization solution
called {Consul}[https://github.com/makandra/consul]. Consul has a very different
approach than Aegis. You might want to compare both solutions and see how they
